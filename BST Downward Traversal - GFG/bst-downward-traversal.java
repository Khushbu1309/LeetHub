...
class Solution
{
    ...
    long verticallyDownBST(Node root,int target)
    {
        ...
        if(tarNode.left!=null){
            Q.add(new Pair(tarNode.left,-1));
        }
        if(tarNode.right!=null){
            Q.add(new Pair(tarNode.right,+1));
        }
        
        while(!Q.isEmpty()){
            Node nodeVal=Q.peek().first;
            ...
            if(nodeVal.left!=null){
                Q.add(new Pair(nodeVal.left,level-1));
            }
            if(nodeVal.right!=null){
                Q.add(new Pair(nodeVal.right,level+1));
            }
